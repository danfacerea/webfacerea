			...
			>
				<div id="lpage" className={`${fullscreen ? "" : "flex-1"}`}>
					<img
						...
						className={`max-h-bookMobile md:max-h-book w-150% aspect-auto ${loadedL ? "" : "animate-pulse-fast"}`}
				...
				>
					<img
						...
						alt={`${t("page")} ${page - offset}`}
						className={`max-h-bookMobile md:max-h-book w-150% aspect-auto ${loadedR ? "" : "animate-pulse-fast"}`}
